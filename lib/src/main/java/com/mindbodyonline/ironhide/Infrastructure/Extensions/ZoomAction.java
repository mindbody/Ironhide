...
public class ZoomAction implements ViewAction {
    ...
    public ZoomAction(Pair<Point, Point> startPoints, Pair<Point, Point> endPoints, long durationMillis) {
        this.coordinates = new PointerCoords[2];
        this.properties = new PointerProperties[2];
        this.steps = new PointF[2];
        this.endPoints = endPoints;
        this.duration = durationMillis / EVENT_MIN_INTERVAL;
    ...
    public void perform(UiController uiController, View view) {
        ...
        try {
            ...
            for (long i = 0; i < duration; i++) {
                ...
                uiController.injectMotionEvent(obtainWrapper(startTime, startTime + i * EVENT_MIN_INTERVAL, ACTION_MOVE, 2));
            }
            ...
            uiController.injectMotionEvent(obtainWrapper(startTime, startTime + duration, ACTION_POINTER_UP + action2Mod, 2));
